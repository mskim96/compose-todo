...
internal fun BookmarksScreen(
    bookmarksUiState: BookmarkTasksUiState,
    onTaskClick: (Task) -> Unit,
    ...
    Scaffold(
        ...
        topBar = {
            BookmarksTopAppBar(
                hasCompletedTask = bookmarksUiState.completedTasks.isNotEmpty(),
                openDrawer = openDrawer,
        ...
        if (!bookmarksUiState.isLoading && bookmarksUiState.empty) {
            TasksEmptyContent(
                noTaskIcon = MonoIcons.BookmarksOutlined,
                noTasksLabel = R.string.no_tasks_bookmark
            )
        } else {
            when (bookmarksUiState.selectedSortType) {
                TaskSortingType.NONE -> {
                    BookmarksContent(
                        activeTasks = bookmarksUiState.activeTasks,
                        completedTasks = bookmarksUiState.completedTasks,
                        isAscending = bookmarksUiState.isAscending,
                        onTaskClick = onTaskClick,
                        selectedSortType = bookmarksUiState.selectedSortType,
                        onSortNoneTasks = onSortNoneTasks,
                        onSortDateTasks = onSortDateTasks,
                        onOrderChanged = { onOrderChange(!bookmarksUiState.isAscending) },
                ...
                TaskSortingType.DATE -> {
                    BookmarksWithDateContent(
                        activeTasksWithDate = bookmarksUiState.activeTasksByDate,
                        completedTasks = bookmarksUiState.completedTasks,
                        isAscending = bookmarksUiState.isAscending,
                        selectedSortType = bookmarksUiState.selectedSortType,
                        onSortNoneTasks = onSortNoneTasks,
...
@Composable
internal fun BookmarksWithDateContent(
