...
internal fun TaskListScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TaskListTopAppBar(
                taskListTitle = taskListUiState.selectedTaskList?.name ?: "",
                hasCompletedTask = taskListUiState.completedTasks.isNotEmpty(),
                openDrawer = openDrawer,
        ...
        if (!taskListUiState.isLoading && taskListUiState.empty) {
            TasksEmptyContent(
                noTaskIcon = MonoIcons.Tasks,
                noTasksLabel = R.string.no_tasks
            )
        } else {
            when (taskListUiState.selectedSortType) {
                TaskSortingType.NONE -> {
                    TasksContent(
                        activeTasks = taskListUiState.activeTasks,
                        completedTasks = taskListUiState.completedTasks,
                        isAscending = taskListUiState.isAscending,
                        onTaskClick = onTaskClick,
                        selectedSortType = taskListUiState.selectedSortType,
                        onSortNoneTasks = onSortNoneTasks,
                        onSortDateTasks = onSortDateTasks,
                        onOrderChanged = { onOrderChange(!taskListUiState.isAscending) },
                ...
                TaskSortingType.DATE -> {
                    TasksWithDateContent(
                        activeTasksWithDate = taskListUiState.activeTasksByDate,
                        completedTasks = taskListUiState.completedTasks,
                        isAscending = taskListUiState.isAscending,
                        selectedSortType = taskListUiState.selectedSortType,
                        onSortNoneTasks = onSortNoneTasks,
