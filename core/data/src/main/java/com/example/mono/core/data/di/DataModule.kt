...
import com.example.mono.core.data.repository.DefaultSubTaskRepository
...
interface DataModule {
    ...
    @Binds
    fun bindsSubTaskRepository(subTaskRepository: DefaultSubTaskRepository): SubTaskRepository
